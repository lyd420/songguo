...
export const STORAGE_KEYS = {
    ...
    WRITING_CALENDAR: 'novel_writing_calendar'
};
...
export const BOOK_STATUS = {
    ongoing: { name: '连载中', color: '#52c41a' },
    completed: { name: '已完结', color: '#1890ff' },
    draft: { name: '草稿', color: '#fa8c16' }
};

// 角色类型配置
export const ROLE_TYPES = {
    protagonist: { name: '主角', color: '#fa8c16', icon: '👑' },
    antagonist: { name: '反派', color: '#f5222d', icon: '👹' },
    supporting: { name: '配角', color: '#1890ff', icon: '🎭' },
    minor: { name: '龙套', color: '#52c41a', icon: '👤' }
};

// 标记类型配置
export const MARK_TYPES = {
    todo: { icon: '📝', label: '待修改', color: '#fa8c16' },
    question: { icon: '❓', label: '疑问', color: '#1890ff' },
    idea: { icon: '💡', label: '灵感', color: '#52c41a' },
    issue: { icon: '⚠️', label: '问题', color: '#f5222d' }
};
